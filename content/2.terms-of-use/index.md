...
---
  ...
  <!-- <div style="position: relative; width: 100%; max-width: 800px; filter: drop-shadow(0 1px 1px rgb(255 255 255 / 0.05));">
      <img src="/bitnetmarket/terms-of-use.png" alt="شرایط و مقررات مارکت"
      class="rounded-lg"
      style="width: 100%; height: auto; display: block;">
      <img src="/bitnetmarket_logo.svg" alt="شرایط و مقررات مارکت" style="position: absolute; margin: 0; top: 45%; left: 50%; transform: translate(-50%, -50%); width: 25%; height: auto; filter: blur(0.7px) drop-shadow(2px 2px 5px rgba(0, 0, 0, 0.8));">
      <div style="position: absolute; margin: 0; top: 46%; left: 50%; transform: translate(-50%, -50%); width: auto; height: auto; text-align: center; filter: blur(0.7px) drop-shadow(2px 2px 5px rgba(0, 0, 0, 0.8)); color: black; font-size: 2.8em; white-space: nowrap; letter-spacing: -0.05em; line-height: 1;">
          بیت نت <br> مارکت
      </div>
  </div> -->
